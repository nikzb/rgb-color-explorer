  ...
  render() {
    return (
      <div className='ColorControls__container'>
        ...
        <ColorControlPanel colorCode={this.props.colorCode} onColorChange={this.props.onColorChange} inCodeEditMode={this.props.inCodeEditMode} addSymbolToCode={this.props.addSymbolToCode} activeSymbolButtons={this.props.activeSymbolButtons} />
